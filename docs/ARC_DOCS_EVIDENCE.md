...
> Arc Mainnet'e deploy edilmiş, manifest `configured`, controller/marketplace pause ve
...
2. Arc Mainnet canlı RPC/receipt/event/code-hash fixture'ı;
...
| --- | --- | --- |
| Arc Mainnet chain ID `5042` | [Arc chain overview](https://docs.arc.io/arc-chain) | Exact chain guard |
| Proje HTTP RPC `https://rpc.mainnet.arc.io` | Live `eth_chainId=5042` ve canonical manifest | Bu release'in tek operational HTTP endpoint'i; fallback yok |
...
| Explorer `https://explorer.arc.io` | [Connect to Arc](https://docs.arc.io/arc/references/connect-to-arc) | Tx/contract links |
...
CAIP-2 `eip155:5042`, EIP-155 chain ID'den türetilir ve Circle x402 Arc örneğinde
de kullanılır.
...
`deployments/evidence/5042/contour-v1/arcscan-source-verification.json` içinde URL,
verification zamanı ve exact response SHA-256 ile pinlenir. Eski
`deployments/evidence/5042/contour-v1/arcscan/` dosyaları retired Safe suite'e aittir ve
...
| --- | --- | --- |
| Registry | [`0xdD69…F8482`](https://explorer.arc.io/api/v2/smart-contracts/0xdd69b92f6fae6da3825b7d126fe058e78e7f8482) | `is_verified:true`, ABI/constructor eşleşiyor |
| Base registrar | [`0x0DF1…B907`](https://explorer.arc.io/api/v2/smart-contracts/0x0df136b94f99cafcc010723b51f8d8ec10a0b907) | `is_verified:true`, ABI/constructor eşleşiyor |
| Controller | [`0xFbA7…B6A3`](https://explorer.arc.io/api/v2/smart-contracts/0xfba7618c929075728b82c69b0b2a8c8d98e4b6a3) | `is_verified:true`, ABI/constructor eşleşiyor |
| Public resolver | [`0x3Ea0…7f5C`](https://explorer.arc.io/api/v2/smart-contracts/0x3ea097ffc2089a5ae24df46f18d621d007577f5c) | `is_verified:true`, ABI/constructor eşleşiyor |
| Reverse registrar | [`0x5ecE…6837`](https://explorer.arc.io/api/v2/smart-contracts/0x5ece3f5815813668307bdce1405b5c765e526837) | `is_verified:true`, ABI/constructor eşleşiyor |
| Universal resolver | [`0x3FAD…8Bf0`](https://explorer.arc.io/api/v2/smart-contracts/0x3fad66f9f3ca165118d5b292fa6036e273718bf0) | `is_verified:true`, ABI/constructor eşleşiyor |
| Marketplace | [`0xD63f…ca46`](https://explorer.arc.io/api/v2/smart-contracts/0xd63f77a01de40b3964051ba03f4158cceff1ca46) | `is_verified:true`, ABI/constructor eşleşiyor |
...
| İddia | Kaynak | Karar |
| --- | --- | --- |
| Arc Mainnet Gateway domain `26`, nanopayment destekli | [Supported blockchains](https://developers.circle.com/gateway/references/supported-blockchains) | Future capability |
| `network: eip155:5042`, `scheme: exact`, 6d USDC | [Seller quickstart](https://developers.circle.com/gateway/nanopayments/quickstarts/seller) | Future profile pin |
...
| USDC implementation EIP-3009/EIP-2612 ABI içeriyor | [USDC proxy](https://explorer.arc.io/address/0x3600000000000000000000000000000000000000), [verified implementation](https://explorer.arc.io/address/0x3910B7cbb3341f1F4bF4cEB66e4A2C8f204FE2b8) | Capability var; v1 disabled |
...
Arc Mainnet için şu adresleri yayınlar:
...
- doğru ilişki dili “Contour, Arc Mainnet üzerinde çalışan bağımsız bir uygulamadır” ve
  kısa network bağlamında “Built on Arc Mainnet”tir;
- Arc Mainnet entegrasyonu Circle/Arc ortaklığı, sponsorluğu, resmî ürün statüsü veya
