...
is active on Arc Mainnet and all seven contracts are source-verified: ArcScan v2 returns
...
the canonical addresses/positive blocks from `deployments/5042.json`, immutable
ArcScan API snapshots from
`https://explorer.arc.io/api/v2/smart-contracts/{address}` plus SHA-256 pairs,
