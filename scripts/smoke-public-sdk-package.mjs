...
try {
  ...
  await writeFile(
    ...
    [
      ...
      '  let rejectedNonActive = false;',
      '  try { prepareApprovalPlan(manifest, expectedAmount); } catch { rejectedNonActive = true; }',
      '  if (!rejectedNonActive) throw new Error("non-active manifest was not rejected");',
      '} else {',
      ...
      '  };',
      '  const registration = prepareRegistrationPlan(registrationInput);',
      ...
      '  const plans = [approval, registration, listing, purchase];',
