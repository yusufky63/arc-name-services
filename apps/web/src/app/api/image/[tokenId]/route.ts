...
import { apiError, CORS_HEADERS, OPTIONS } from "../../_shared/http";
...
export async function GET(
  ...
  try {
    ...
    return new Response(renderNameNftSvg(snapshot), {
      headers: {
        ...CORS_HEADERS,
    ...
    return apiError(
      503,
      "NFT_IMAGE_UNAVAILABLE",
      "Arc could not complete the verified NFT image read.",
    );
  }
}
